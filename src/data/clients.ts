...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    company: 'Unilab',
    text: 'Дмитрий помог нам выстроить единый визуальный язык для всей продуктовой линейки. Работает аккуратно, в срок, без лишних вопросов.',
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=96&h=96&fit=crop&crop=face',
    highlight: 'единый визуальный язык',
  },
  {
    id: 11,
    name: 'Анна Белова',
    role: 'CMO',
    company: 'Pulse Media',
    text: 'Заказали дизайн лендинга под конференцию. Получилось стильно, читабельно и конверсионно. Результат: 18% рост регистраций. Рекомендую.',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=96&h=96&fit=crop&crop=face',
    highlight: '18% рост регистраций',
  },
  {
    id: 12,
    name: 'Максим Сидоров',
    role: 'Co-Founder',
    company: 'TrustBank',
    text: 'Работали над редизайном мобильного банка. Дмитрий предложил неожиданно смелые решения, которые прошли пользовательское тестирование на отлично.',
    avatar: 'https://images.unsplash.com/photo-1463453091185-61582044d556?w=96&h=96&fit=crop&crop=face',
    highlight: 'прошли пользовательское тестирование',
  },
]
